            ...
            <div class="productUnit" price="${p.promotePrice}">
                <div class="productUnitFrame">
                    ...
                    <div class="show1 productInfo">
                        <span class="monthDeal ">月成交 <span class="productDealNumber">${p.saleQuantity}笔</span></span>
                        <span class="productReview">评价<span class="productReviewNumber">${p.reviewQuantity}</span></span>
                        <span class="wangwang">
