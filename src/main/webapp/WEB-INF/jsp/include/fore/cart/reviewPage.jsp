...
<div class="reviewDiv">
    <div class="reviewProductInfoDiv">
        ...
        <div class="reviewProductInfoRightDiv">
            ...
            <table class="reviewProductInfoTable">
                ...
                <tr>
                    <td>月销量:</td>
                    <td><span class="reviewProductInfoTableSellNumber">${p.saleQuantity}</span> 件</td>
                </tr>
            </table>
    ...
    <div class="reviewStasticsDiv">
        <div class="reviewStasticsLeft">
            ...
            <div class="reviewStasticsLeftContent">累计评价 <span class="reviewStasticsNumber"> ${p.reviewQuantity}</span></div>
